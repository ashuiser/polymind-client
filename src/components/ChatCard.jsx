...
export default function ChatCard() {
  ...
  const handleInput = (e) => {
    ...
    const shouldExpand = newHeight > 80;
  ...
  return (
    <div className="w-full max-w-3xl px-4">
      <form onSubmit={handleSubmit}>
        <div className={`relative w-full bg-[#0f0f0f] px-4 py-3 shadow-inner transition-colors duration-150 min-h-[3.5rem] max-h-[12rem] border border-[#282828] focus-within:border-[#454545] ${isExpanded ? 'rounded-2xl' : 'rounded-full'
          }`}>
            ...
            {isExpanded ? (
              <>
                ...
                <div className="relative flex-1">
                  ...
                  <textarea
                    ...
                    className="bg-transparent resize-none w-full text-white placeholder:text-gray-400 focus:outline-none max-h-[8rem] overflow-auto 
              ...
              <>
                ...
                <textarea
                  ...
                  rows={1}
                  placeholder="Ask anything"
                  className="bg-transparent resize-none w-full text-white placeholder:text-gray-400 focus:outline-none max-h-[8rem] overflow-hidden"
